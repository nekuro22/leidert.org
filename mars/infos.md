...
Der Mars verfügt derzeit über Merkmale, die eine menschliche Besiedlung ohne massive technologische Unterstützung unmöglich machen:
...
Um eine atembare Atmosphäre zu schaffen, müssen die im Gestein gebundenen Gase freigesetzt werden.
...
| Prozess | Reaktionsgleichung | Nutzen |
|---------|-------------------|--------|
| Sabatier-Reaktion | CO₂ + 4H₂ → CH₄ + 2H₂O | Erzeugung von Methan (Treibstoff) und Wasser |
| Elektrolyse | 2H₂O → 2H₂ + O₂ | Gewinnung von Sauerstoff und Wasserstoff |
| Serpentinisierung | Olivin + H₂O → H₂ + Beiprodukte | Passive Gewinnung von Wasserstoff aus Marsgestein |
